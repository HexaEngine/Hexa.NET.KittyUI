namespace Kitty.Graphics
{
    ...
    public struct TextureDescription : IEquatable<TextureDescription>
    {
        ...
        public TextureDescription(
            ...
            Format format = Format.R16G16B16A16Float,
        ...
        /// <returns></returns>
        public static TextureDescription CreateTexture1D(int width, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture1DWithRTV(int width, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource | BindFlags.RenderTarget, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
            return new TextureDescription(TextureDimension.Texture1D, width, 0, 0, mips, format, usage, bindFlags, cpuAccessFlags, resourceOptionFlags);
        }
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture1DArray(int width, int arraySize, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture1DArrayWithRTV(int width, int arraySize, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource | BindFlags.RenderTarget, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
            return new TextureDescription(TextureDimension.Texture1D, width, 0, 0, arraySize, mips, format, usage, bindFlags, cpuAccessFlags, resourceOptionFlags);
        }
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture2D(int width, int height, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture2DWithRTV(int width, int height, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource | BindFlags.RenderTarget, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
            return new TextureDescription(TextureDimension.Texture2D, width, height, 0, mips, format, usage, bindFlags, cpuAccessFlags, resourceOptionFlags);
        }
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture2DArray(int width, int height, int arraySize, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture2DArrayWithRTV(int width, int height, int arraySize, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource | BindFlags.RenderTarget, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
            return new TextureDescription(TextureDimension.Texture2D, width, height, 0, arraySize, mips, format, usage, bindFlags, cpuAccessFlags, resourceOptionFlags);
        }
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTextureCube(int width, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.TextureCube)
        {
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTextureCubeWithRTV(int width, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource | BindFlags.RenderTarget, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.TextureCube)
        {
            return new TextureDescription(TextureDimension.TextureCube, width, width, 0, 6, mips, format, usage, bindFlags, cpuAccessFlags, resourceOptionFlags);
        }
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTextureCubeArrayWithRTV(int width, int size, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource | BindFlags.RenderTarget, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.TextureCube)
        {
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture3D(int width, int height, int depth, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
        ...
        /// <param dbgName="resourceOptionFlags">The resource option flags.</param>
        /// <returns></returns>
        public static TextureDescription CreateTexture3DWithRTV(int width, int height, int depth, int mips, Format format = Format.R16G16B16A16Float, Usage usage = Usage.Default, BindFlags bindFlags = BindFlags.ShaderResource | BindFlags.RenderTarget, CpuAccessFlags cpuAccessFlags = CpuAccessFlags.None, ResourceMiscFlag resourceOptionFlags = ResourceMiscFlag.None)
        {
            return new TextureDescription(TextureDimension.Texture3D, width, height, depth, mips, format, usage, bindFlags, cpuAccessFlags, resourceOptionFlags);
        }
