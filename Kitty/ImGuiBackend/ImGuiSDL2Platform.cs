...
#pragma warning restore MNF001 // Class/Struct Member Not Freed
                ...
                case SDLEventType.Windowevent:
                    {
                        ...
                        SDLWindowEventID window_event = (SDLWindowEventID)env.Window.Event;
        ...
        public static unsafe bool Init(SDLWindow* window, SDLRenderer* renderer, SDLGLContext sdlGLContext)
        {
            var io = ImGui.GetIO();
        ...
        public static unsafe bool InitForOpenGL(SDLWindow* window, SDLGLContext sdl_gl_context)
        {
        ...
        {
            return Init(window, null, default);
        }
        ...
        {
            return Init(window, renderer, default);
        }
        ...
        private static unsafe void InitPlatformInterface(SDLWindow* window, SDLGLContext sdl_gl_context)
        {
            ImGuiPlatformIO* platform_io = ImGui.GetPlatformIO();
